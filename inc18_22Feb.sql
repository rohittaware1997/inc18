...
INSERT INTO `groups` VALUES (3,5,'iii','sss','hhh','aaa','nnn','bits',''),(7,5,'a','','','','','vit','xyz'),(34,3,'vv','','','','','asklf',''),(444,1,'a','b','c','d','','pict','');
...
INSERT INTO `judges` VALUES (1,'Aditya','ad@gmail.com','992',0),(11,'Aditay','ad@gmail.com','992',0),(12,'Ad','ad@gmail.com','992',0),(32,'Omkesh','om@gmail.com','889',0),(34,'Atharva','ath@gmail.com','7878',0),(67,'Ish','is@gmail.com','666',0);
...
INSERT INTO `marks` VALUES (1,3,3,40,0),(1,3,34,12,0),(1,4,444,30,0),(1,5,3,34,0),(1,6,3,45,0);
...
CREATE TABLE `result` (
  `pdid` int(11) NOT NULL,
  `pid` int(11) NOT NULL,
  `n_judges` int(11) NOT NULL DEFAULT '0',
...
-- Dump completed on 2018-02-22 18:52:44
